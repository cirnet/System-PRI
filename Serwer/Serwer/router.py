...
router.register('available-time-slot', AvailableTimeSlotViewset, basename="ats")
router.register('coordinator-time-slot', CoordinatorTimeSlotViewset)
router.register('team', TeamViewset)
router.register('project', ProjectViewset)
router.register(f'{studentprefix}project-grade-card', ProjectGradeCardViewset)
router.register('evaluation-criteria', EvaluationCriteriaViewset)